...
# Checks if Apache is responding by fetching the server-status page. If Apache
# is not responding, saves diagnostic info and restarts the service via systemctl.
